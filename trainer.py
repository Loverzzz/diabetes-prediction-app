...
def input_fn(file_pattern, tf_transform_output, batch_size=64):
    ...
    Args:
        ...
        batch_size: Number of consecutive elements of returned dataset to combine in a single batch.
...
def run_fn(fn_args):
    ...
    # Save the model with a serving signature
    signatures = {
    ...
    try:
        ...
        print("Model plot saved successfully.")
